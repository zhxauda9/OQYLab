            ...
            <div class="show comments">
                <?php
                    ...
                    if($select_comments->rowCount()> 0){
                        while($fetch_comment=$select_comments->fetch(PDO::FETCH_ASSOC)){
                            ...
                            $fetch_content=$select_comment->fetch(PDO::FETCH_ASSOC);
                ?>
                <div class="box" style="<?php if($fetch_comment['tutor_id']==$tutor_id){echo 'order:-1';}?>">
                    ...
                    <form action="" method="post">
                        ...
                        <button type="submit" name="delete_comment" value="delete comment" class="btn" onclick="return confirm('delete this comment');">delete comment</button>
                    </form>
                <?php
                        }
                    }else{
